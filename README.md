...
## The six measured facts the architecture rests on
...
3. **A hook cannot orchestrate.** It can emit a directive via `hookSpecificOutput.additionalContext`; it cannot spawn an agent or run a workflow.
